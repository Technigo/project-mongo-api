...
var _elves2 = _interopRequireDefault(require("./data/elves.json"));
...
app.get("/elves/json", function (request, response) {
  response.json(_elves2["default"]); // Return content from JSON-file
});
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            _context2.next = 6;
            return Promise.all(_elves2["default"].map(/*#__PURE__*/function () {
