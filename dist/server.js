...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //import seedDatabase from "./scripts/seedDatabase"
/**
...
app.get("/elves", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, response) {
    var _request$query, title, top_twelves, query, limit, elves;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 7;
          return Elf.find(query).sort({
            elfID: 1
          }) // Sort elfID in ascending order (1 for ascending, -1 for descending)
          .limit(limit);
        case 7:
          elves = _context.sent;
          response.json(elves);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if (elf) {
            ...
            response.status(404).json({
              error: "404 - No elf found with that ID"
            });
          }
          _context2.next = 12;
          break;
        case 8:
          ...
          console.error("Error fetching elf by ID:", _context2.t0);
          response.status(500).json({
