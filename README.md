...
<body>
  ...
  "properties" : {
    "_id" : {
      "type" : "object",
      "example" : "609c62ddb14fe7283c71e314"
    },
    "name" : {
      "type" : "string",
      "example" : "Alicia Keys - Gold Lounge"
    },
    "type" : {
      "type" : "string",
      "example" : "event"
  ...
  "oneOf" : [ {
    ...
    "$ref" : "#/components/schemas/noHits"
  } ]
};
            defs["inline_response_404"] = {
  "oneOf" : [ {
    "$ref" : "#/components/schemas/invalidId"
  }, {
    "$ref" : "#/components/schemas/noPage"
  } ]
};
            defs["invalidId"] = {
  "type" : "object",
  ...
  "properties" : {
    "error" : {
      "type" : "string",
      "example" : "No connection to server"
    }
  }
};
            defs["noHits"] = {
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Endpoints"><a href="#api-Endpoints">API Methods - Endpoints</a></li>
                    <li data-group="Endpoints" data-name="rootGet" class="">
                      <a href="#api-Endpoints-rootGet">rootGet</a>
                    </li>
                  <li class="nav-header" data-group="Events"><a href="#api-Events">API Methods - Events</a></li>
                    <li data-group="Events" data-name="eventsGet" class="">
                      <a href="#api-Events-eventsGet">eventsGet</a>
                    </li>
                    <li data-group="Events" data-name="eventsSummer21Get" class="">
                      <a href="#api-Events-eventsSummer21Get">eventsSummer21Get</a>
                    </li>
                  <li class="nav-header" data-group="SingleEvent"><a href="#api-SingleEvent">API Methods - SingleEvent</a></li>
                    <li data-group="SingleEvent" data-name="eventsIdIdGet" class="">
                      <a href="#api-SingleEvent-eventsIdIdGet">eventsIdIdGet</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>This is a simpe API to find events that sells via Ticketmaster.</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Endpoints">
                  <h1>Endpoints</h1>
                    <div id="api-Endpoints-rootGet">
                      <article id="api-Endpoints-rootGet-0" data-group="User" data-name="rootGet" data-version="0">
                        <div class="pull-left">
                          <h1>rootGet</h1>
                          <p>Displays all endpoints for this API as links</p>
                        </div>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Endpoints-rootGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Endpoints-rootGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Endpoints-rootGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Endpoints-rootGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Endpoints-rootGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Endpoints-rootGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Endpoints-rootGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Endpoints-rootGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Endpoints-rootGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Endpoints-rootGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Endpoints-rootGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Endpoints-rootGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/Pauan86/Ticketmaster/1.0.1/"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Endpoints-rootGet-0-java">
...
public class EndpointsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            array[inline_response_200] result = apiInstance.rootGet();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EndpointsApi#rootGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Endpoints-rootGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EndpointsApi;
...
public class EndpointsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Endpoints-rootGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Endpoints-rootGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">
EndpointsApi *apiInstance = [[EndpointsApi alloc] init];

// Displays all endpoints for this API as links
[apiInstance rootGetWithCompletionHandler: 
              ^(array[inline_response_200] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Endpoints-rootGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TicketmasterEvents = require('ticketmaster_events');

var api = new TicketmasterEvents.EndpointsApi()
...
api.rootGet(callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Endpoints-rootGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Endpoints-rootGet-0-csharp">
...
namespace Example
{
    public class rootGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling EndpointsApi.rootGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Endpoints-rootGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiEndpointsApi();

try {
    $result = $api_instance->rootGet();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EndpointsApi->rootGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Endpoints-rootGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EndpointsApi;

my $api_instance = WWW::SwaggerClient::EndpointsApi->new();
...
if ($@) {
    warn "Exception when calling EndpointsApi->rootGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Endpoints-rootGet-0-python">
...
try: 
    ...
    print("Exception when calling EndpointsApi->rootGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Succesful connection </h3>
                                ...
                                <div class="tab-pane active" id="responses-rootGet-200-schema">
                                  <div id='responses-rootGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Succesful connection",
  "content" : {
    "application/json" : {
      "schema" : {
        "type" : "array",
        ...
        "x-content-type" : "application/json"
                            ...
                            <h3> Status: 404 - No connection to server </h3>
                ...
                <section id="api-Events">
                  <h1>Events</h1>
                    <div id="api-Events-eventsGet">
                      <article id="api-Events-eventsGet-0" data-group="User" data-name="eventsGet" data-version="0">
                        <div class="pull-left">
                          <h1>eventsGet</h1>
                          <p>Get event data</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Returns all the events active at Ticketmaster at this time</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/events</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-eventsGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-eventsGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-eventsGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-eventsGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-eventsGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-eventsGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-eventsGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-eventsGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-eventsGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-eventsGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-eventsGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-eventsGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/Pauan86/Ticketmaster/1.0.1/events?country=&title=&artist="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-eventsGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        String country = country_example; // String | Filter by country code. Needs to match exact. Case sensitive.
        String title = title_example; // String | Filter by title of show. Finds shows that includes the word. Case insensitive.
        String artist = artist_example; // String | Filter by artist name. Finds attractions that includes the name. Case insensitive.
        try {
            inline_response_200_1 result = apiInstance.eventsGet(country, title, artist);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Events-eventsGet-0-android">
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-eventsGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-eventsGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *country = country_example; // Filter by country code. Needs to match exact. Case sensitive. (optional)
String *title = title_example; // Filter by title of show. Finds shows that includes the word. Case insensitive. (optional)
String *artist = artist_example; // Filter by artist name. Finds attractions that includes the name. Case insensitive. (optional)

EventsApi *apiInstance = [[EventsApi alloc] init];

// Get event data
[apiInstance eventsGetWith:country
    title:title
    artist:artist
              completionHandler: ^(inline_response_200_1 output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Events-eventsGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TicketmasterEvents = require('ticketmaster_events');

var api = new TicketmasterEvents.EventsApi()
var opts = { 
  'country': country_example, // {{String}} Filter by country code. Needs to match exact. Case sensitive.
  'title': title_example, // {{String}} Filter by title of show. Finds shows that includes the word. Case insensitive.
  'artist': artist_example // {{String}} Filter by artist name. Finds attractions that includes the name. Case insensitive.
};
var callback = function(error, data, response) {
  if (error) {
    console.error(error);
...
api.eventsGet(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Events-eventsGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-eventsGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class eventsGetExample
    {
        public void main()
        {
            ...
            var country = country_example;  // String | Filter by country code. Needs to match exact. Case sensitive. (optional) 
            var title = title_example;  // String | Filter by title of show. Finds shows that includes the word. Case insensitive. (optional) 
            var artist = artist_example;  // String | Filter by artist name. Finds attractions that includes the name. Case insensitive. (optional) 
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling EventsApi.eventsGet: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Events-eventsGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->eventsGet($country, $title, $artist);
    print_r($result);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Events-eventsGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;

my $api_instance = WWW::SwaggerClient::EventsApi->new();
my $country = country_example; # String | Filter by country code. Needs to match exact. Case sensitive.
my $title = title_example; # String | Filter by title of show. Finds shows that includes the word. Case insensitive.
my $artist = artist_example; # String | Filter by artist name. Finds attractions that includes the name. Case insensitive.

eval { 
    my $result = $api_instance->eventsGet(country => $country, title => $title, artist => $artist);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling EventsApi->eventsGet: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Events-eventsGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
country = country_example # String | Filter by country code. Needs to match exact. Case sensitive. (optional)
title = title_example # String | Filter by title of show. Finds shows that includes the word. Case insensitive. (optional)
artist = artist_example # String | Filter by artist name. Finds attractions that includes the name. Case insensitive. (optional)

try: 
    # Get event data
    api_response = api_instance.events_get(country=country, title=title, artist=artist)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EventsApi->eventsGet: %s\n" % e)</code></pre>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <td>
                                    ...
                                    <div id="d2e199_eventsGet_country">
                                            ...
                                            <div class="primitive">
                                                <span class="type">
                                                    ...
                                                    <div class="inner description">
                                                        Filter by country code. Needs to match exact. Case sensitive.
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="json-schema-view">
                                            <div class="primitive">
                                                <span class="type">
                                                    ...
                                                    <div class="inner description">
                                                        Filter by title of show. Finds shows that includes the word. Case insensitive.
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tr><td style="width:150px;">artist</td>
                                <td>
                                
                                
                                    <div id="d2e199_eventsGet_artist">
                                        <div class="json-schema-view">
                                            <div class="primitive">
                                                <span class="type">
                                                    String
                                                    ...
                                                    <div class="inner description">
                                                        Filter by artist name. Finds attractions that includes the name. Case insensitive.
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Result </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsGet-200-schema">
                                  <div id='responses-eventsGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Result",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/inline_response_200_1"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 404 - Error </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsGet-404-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsGet-404-schema">
                                  <div id='responses-eventsGet-404-schema-404' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Error",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/noPage"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsGet-404-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsGet-404-schema-404');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsGet-404-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 503 - Error </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsGet-503-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsGet-503-schema">
                                  <div id='responses-eventsGet-503-schema-503' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Error",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/noConnection"
      }
    }
  }
};
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsGet-503-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsGet-503-schema-503');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsGet-503-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Events-eventsSummer21Get">
                      <article id="api-Events-eventsSummer21Get-0" data-group="User" data-name="eventsSummer21Get" data-version="0">
                        <div class="pull-left">
                          <h1>eventsSummer21Get</h1>
                          <p>Get event data for the summer months</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Returns all the events active at Ticketmaster between 2021-05-01 and 2021-09-01</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/events/summer21</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-eventsSummer21Get-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-eventsSummer21Get-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-eventsSummer21Get-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-eventsSummer21Get-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-eventsSummer21Get-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/Pauan86/Ticketmaster/1.0.1/events/summer21"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        EventsApi apiInstance = new EventsApi();
        try {
            inline_response_200_1 result = apiInstance.eventsSummer21Get();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EventsApi#eventsSummer21Get");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">
EventsApi *apiInstance = [[EventsApi alloc] init];

// Get event data for the summer months
[apiInstance eventsSummer21GetWithCompletionHandler: 
              ^(inline_response_200_1 output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TicketmasterEvents = require('ticketmaster_events');
...
api.eventsSummer21Get(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Events-eventsSummer21Get-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class eventsSummer21GetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling EventsApi.eventsSummer21Get: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->eventsSummer21Get();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EventsApi->eventsSummer21Get: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;
...
eval { 
    my $result = $api_instance->eventsSummer21Get();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling EventsApi->eventsSummer21Get: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-eventsSummer21Get-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get event data for the summer months
    api_response = api_instance.events_summer21_get()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EventsApi->eventsSummer21Get: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsSummer21Get-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsSummer21Get-200-schema">
                                  <div id='responses-eventsSummer21Get-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Result",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/inline_response_200_1"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsSummer21Get-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsSummer21Get-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsSummer21Get-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsSummer21Get-404-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsSummer21Get-404-schema">
                                  <div id='responses-eventsSummer21Get-404-schema-404' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Error",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/noPage"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsSummer21Get-404-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsSummer21Get-404-schema-404');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsSummer21Get-404-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsSummer21Get-503-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsSummer21Get-503-schema">
                                  <div id='responses-eventsSummer21Get-503-schema-503' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Error",
    ...
    "application/json" : {
      "schema" : {
        ...
        "x-content-type" : "application/json"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsSummer21Get-503-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsSummer21Get-503-schema-503');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsSummer21Get-503-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-SingleEvent">
                  <h1>SingleEvent</h1>
                    <div id="api-SingleEvent-eventsIdIdGet">
                      <article id="api-SingleEvent-eventsIdIdGet-0" data-group="User" data-name="eventsIdIdGet" data-version="0">
                        <div class="pull-left">
                          <h1>eventsIdIdGet</h1>
                          <p>Get one event</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Return a single event with the specific id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/events/id/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SingleEvent-eventsIdIdGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SingleEvent-eventsIdIdGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SingleEvent-eventsIdIdGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/Pauan86/Ticketmaster/1.0.1/events/id/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SingleEventApi;

import java.io.File;
import java.util.*;

public class SingleEventApiExample {

    public static void main(String[] args) {
        
        SingleEventApi apiInstance = new SingleEventApi();
        Object id = ; // Object | Id of event
        try {
            events result = apiInstance.eventsIdIdGet(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SingleEventApi#eventsIdIdGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SingleEventApi;
...
public class SingleEventApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Object *id = ; // Id of event

SingleEventApi *apiInstance = [[SingleEventApi alloc] init];

// Get one event
[apiInstance eventsIdIdGetWith:id
              completionHandler: ^(events output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TicketmasterEvents = require('ticketmaster_events');

var api = new TicketmasterEvents.SingleEventApi()
var id = ; // {{Object}} Id of event
...
api.eventsIdIdGet(id, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class eventsIdIdGetExample
    {
        public void main()
        {

            var apiInstance = new SingleEventApi();
            var id = new Object(); // Object | Id of event
            ...
            {
                Debug.Print("Exception when calling SingleEventApi.eventsIdIdGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiSingleEventApi();
$id = ; // Object | Id of event

try {
    $result = $api_instance->eventsIdIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SingleEventApi->eventsIdIdGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SingleEventApi;

my $api_instance = WWW::SwaggerClient::SingleEventApi->new();
my $id = ; # Object | Id of event

eval { 
    my $result = $api_instance->eventsIdIdGet(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SingleEventApi->eventsIdIdGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SingleEvent-eventsIdIdGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
# create an instance of the API class
api_instance = swagger_client.SingleEventApi()
id =  # Object | Id of event

try: 
    # Get one event
    api_response = api_instance.events_id_id_get(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling SingleEventApi->eventsIdIdGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_eventsIdIdGet_id">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Object
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsIdIdGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsIdIdGet-200-schema">
                                  <div id='responses-eventsIdIdGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Result",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/events"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsIdIdGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsIdIdGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsIdIdGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsIdIdGet-404-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsIdIdGet-404-schema">
                                  <div id='responses-eventsIdIdGet-404-schema-404' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Error",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/inline_response_404"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsIdIdGet-404-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsIdIdGet-404-schema-404');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsIdIdGet-404-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-eventsIdIdGet-503-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-eventsIdIdGet-503-schema">
                                  <div id='responses-eventsIdIdGet-503-schema-503' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Error",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/noConnection"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-eventsIdIdGet-503-schema-data').val(stringify(schema));
                                        var result = $('#responses-eventsIdIdGet-503-schema-503');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-eventsIdIdGet-503-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
