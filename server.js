...
app.get('/btc-historical-prices/2016', async (req, res) => {
  const btcData = await BtcHistorical.find();
  const btc2016 = await btcData.filter((item) => item.SNo === 1099)
  if (btc2016) {
...
app.get('/btc-historical-prices/2017', async (req, res) => {
  const btcData = await BtcHistorical.find();
  const btc2017 = await btcData.filter((item) => item.SNo === 1464)
  if (btc2017) {
...
app.get('/btc-historical-prices/2018', async (req, res) => {
  const btcData = await BtcHistorical.find();
  const btc2018 = await btcData.filter((item) => item.SNo === 1844)
  if (btc2018) {
...
app.get('/btc-historical-prices/2019', async (req, res) => {
  const btcData = await BtcHistorical.find();
  const btc2019 = await btcData.filter((item) => item.SNo === 2196)
  if (btc2019) {
...
app.get('/btc-historical-prices/2020', async (req, res) => {
  const btcData = await BtcHistorical.find();
  const btc2020 = await btcData.filter((item) => item.SNo === 2561)
  if (btc2020) {
...
app.get('/btc-historical-prices/2021', async (req, res) => {
  const btcData = await BtcHistorical.find();
  const btc2021 = await btcData.filter((item) => item.SNo === 2859)
  if (btc2021) {
