...
//envioroment variable: RESET_DB: RESET_DB=true npm run dev
//deleteMany: It's a function from mongoose and it delete all the info we have stored in the database before saving it so it does not duplicate.
...
// This code is the model we created instead of using the json data
